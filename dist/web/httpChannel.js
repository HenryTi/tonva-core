...
var HttpChannel = /** @class */ (function () {
    function HttpChannel(web, hostUrl, apiToken, ui) {
        var _this = this;
    ...
    */
    HttpChannel.prototype.buildHeaders = function () {
        var _a = this.web.tonva.nav, language = _a.language, culture = _a.culture;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        u = this.hostUrl + url;
                        appBridge = this.web.appBridge;
                        if (!(this.apiToken === undefined && appBridge.isBridged())) return [3 /*break*/, 2];
                        return [4 /*yield*/, appBridge.bridgeCenterApi(u, options.method, options.body)];
                    case 1: return [2 /*return*/, _a.sent()];
