...
exports.Tonva = void 0;
var Tonva = /** @class */ (function () {
    function Tonva(uqsConfig) {
        this.uqsConfig = uqsConfig;
    }
    Tonva.prototype.start = function (CApp, appConfig, isUserLogin) {
    ...
    Tonva.prototype.startPage = function (CApp, appConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var cApp;
            return __generator(this, function (_a) {
                switch (_a.label) {
