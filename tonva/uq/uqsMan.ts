...
export class UQsMan {
	...
	async buildUqs(uqDataArr:UqData[], version:string, uqConfigs?:UqConfig[]):Promise<string[]> {
		...
		if (this.web.isBuildingUQ === false) {
    ...
    private showReload(msg: string) {
        ...
        this.web.tonva.nav.showReloadPage(msg);
    }
...
export class UQsManApp extends UQsMan {
