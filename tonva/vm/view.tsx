...
export abstract class ViewCore<E, C extends ControllerCore<E>> {
    ...
    protected renderVm(vm: new (controller: C)=>ViewCore<E, C>, param?:any) {
        return (new vm(this.controller)).render(param);
    }

    protected async openVPage(vp: new (controller: C)=>VPageCore<E, C>, param?:any, afterBack?:()=>Promise<void>):Promise<void> {
    ...
    */
    ...
    protected replacePage(view: E, param?:any) {
        this.controller.replacePage(view, param);
    }

    protected openPageElement(page: E, onClosePage?: ()=>void) {
        this.controller.openPage(page, onClosePage);
    }

    protected replacePageElement(page: E, onClosePage?: ()=>void) {
